D:\Project\commands-for-dev\AI\whisper\.venv\Scripts\activate

> whisper D:\Project\thesucesswaynote\blog\media\tu-duy-lam-viec.mp3 --language Vietnamese --model turbo --output_format txt

> whisper D:\Project\thesucesswaynote\blog\media\tai-sao-lai-co-su-chia-cach-nay.mp3 --language Vietnamese --model turbo --output_format txt --output_dir D:\Project\thesucesswaynote\blog
...
optional arguments:
  ...
  --output_format {txt,vtt,srt,tsv,json,all}, -f {txt,vtt,srt,tsv,json,all}
                        format of the output file; if not specified, all available formats will
                        be produced (default: all)
  ...
  --suppress_tokens SUPPRESS_TOKENS
                        ...
                        suppress most special characters except common punctuations (default:
                        -1)
  --initial_prompt INITIAL_PROMPT
                        optional text to provide as a prompt for the first window. (default:
                        None)
